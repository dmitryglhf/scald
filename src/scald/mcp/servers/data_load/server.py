...
@mcp.tool(description="Load CSV file into Polars DataFrame and return info.")
async def load_csv(
...
@mcp.tool(description="Get first N rows of CSV as preview.")
async def preview_csv(
    file_path: Annotated[str, Field(description="Path to CSV file")],
    n_rows: Annotated[int, Field(description="Number of rows to preview")] = 5,
) -> dict:
...
@mcp.tool(description="Get basic statistics for numeric columns.")
